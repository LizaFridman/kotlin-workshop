 ...
 */
fun helloWithDefaultArguments(firstName : String = "Erez", lastName: String) = println("Hello $firstName $lastName")
 ...
 */
fun schoolSizeTimes(currentStudentSize: Int, times: Int) = currentStudentSize * times
